  ...
  const renderFeaturedItem = () => {
    ...
    return (
      <div className="mb-12">
        ...
        <div className="bg-neutral-800 p-6 rounded-2xl flex items-center space-x-6 shadow-md">
          <img
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-4 gap-6">
          {latestAlbums.map((el, i) => (
            <div
              key={i}
              className="bg-neutral-800 p-4 rounded-xl shadow hover:bg-neutral-700 transition"
            >
              <img
      ...
      <div>
        ...
        <div className="flex space-x-4">
          {artists.map((el, i) => (
            <div
              key={i}
              className="w-40 h-48 flex flex-col items-center text-center bg-neutral-800 p-4 rounded-xl shadow hover:bg-neutral-700 transition"
            >
              <img
                src={`${jellyfinAPI.configuration.basePath}/Items/${el.Id}/Images/Primary?fillHeight=300&fillWidth=300&quality=90`}
